...
We firstly merge pols_month with snp. Next, we merger Joint_df_pol_snp
...
- The snp data has 787 observations and 3 variables, covering years from
  1969 to 2068, and it contains information related to the S&P stock
  market index.
- The unemployment data has 810 observations and 3 variables, spanning
...
- The merged Joint_df_pol_snp_unemploy dataset combines pols_month, snp,
  and unemployment. It has 822 rows and 11 columns, covering years from
  1947 to 2015.
...
- `mr_trash_wheel_df` contains 707 rows and 15 columns of data.
- `professor_trash_wheel_df` contains 132 rows and 14 columns of data.
- `gwynnda_trash_wheel_df` contains 349 rows and 13 columns of data.
- The final data set `trash_wheel_whole_df` contains 1188 rows and 15
...
- Date range of the rent observations: from 2015-01-31 to 2024-08-31
